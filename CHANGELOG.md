...
- Fixed game version detection on import
...
- Changed .version file format to be a textual file that can be edited in a text editor.
...
[unreleased]: https://github.com/an-anime-team/sleepy-launcher/compare/1.6.4...next
